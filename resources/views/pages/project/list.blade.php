                    ...
                    <tbody>
                        @forelse ($projects as $item)
                            <tr>
                                ...
                                <td>
                                    @if ($item->enterprises()->count() > 0)
                                    <button class="btn  btn-primary btn-sm" type="button" data-bs-toggle="modal"
                                        data-bs-target="#enterprise_{{ $item->id }}">
                                        {{ $item->enterprises()->count()}} doanh nghiệp
                                    </button>
                                    @else 
                                    <span>Chưa có doanh nghiệp</span>
                                    @endif
                                    <!-- Modal -->
                                    <div class="modal fade" id="enterprise_{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="col mx-auto">
                                                        <ul>
                                                            @foreach ($item->enterprises as $enterprise)
                                ...
                                <td>
                                    @if ($item->mentors()->count() > 0)
                                    <button class="btn  btn-primary btn-sm" type="button" data-bs-toggle="modal"
                                        data-bs-target="#mentors_{{ $item->id }}">
                                        {{ $item->mentors()->count()}} mentors
                                    </button>
                                    @else 
                                    <span>Chưa có mentor</span>
                                    @endif
                                    <!-- Modal -->
                                    <div class="modal fade" id="mentors_{{ $item->id }}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="col mx-auto">
                                                        <ul>
                                                            ...
                                                            <li>{{$mentor->name}} ({{$mentor->email}})</li>
                                                            @endforeach
                                                        </ul>
                                                    </div>
                                                </div>
                                ...
                                <td>
                                    ...
                                    <span class="badge badge-light-primary">{{$topic->name}}</span>
                                    @endforeach
                                </td>
                                <td>
                                    @if ($item->status == 1)
                                ...
                                <td>
                                    <div data-bs-toggle="tooltip" title="Thao tác" class="btn-group dropstart">
                                        ...
                                        <ul class="dropdown-menu  px-4 ">
                                            ...
                                            <li class="my-3">
                                                <form action="{{ route('admin.project.delete', $item->id) }}"
                                                    id="delete_{{$item->id}}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
