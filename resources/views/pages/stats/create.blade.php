    ...
    <div class="row mb-4">
        <div class="col-lg-12">
            <ol class="breadcrumb text-muted fs-6 fw-bold">
                ...
                <li class="breadcrumb-item px-3 text-muted">Thêm mới thông số</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-flush h-lg-100 p-10">
                <form id="formStat" action="{{ route('admin.stat.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group mb-10">
                                ...
                                <img class="mt-4 border rounded-3" style="max-height:25px" id="image-preview"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-10">
                                <label class="form-label" for="">Gía trị</label>
