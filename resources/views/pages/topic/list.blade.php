...
@section('title', 'Quản lý lĩnh vực dự án')
@section('page-title', 'Quản lý lĩnh vực dự án')
@section('content')
    <div class="card card-flush p-4">
        <div class="row">
            <div class=" col-lg-6">
                <h1>Danh sách lĩnh vực
            ...
            <div class=" col-lg-6">
                <div class=" d-flex flex-row-reverse bd-highlight">
                    <a class="btn btn-primary" onclick="openCreateModal()">
                        Tạo lĩnh vực mới
                    </a>
                </div>
            </div>
                                ...
                                <td>
                                    <div data-bs-toggle="tooltip" title="Thao tác" class="btn-group dropstart">
                                        ...
                                        <ul class="dropdown-menu  px-4 ">
                                            <li class="my-3">
                                                <a href="{{ route('admin.topic.edit', $item->id) }}">
